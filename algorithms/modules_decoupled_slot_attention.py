...
from utils.utils_slot_attention import build_grid
from utils.utils_slot_attention import conv_transpose_out_shape

from utils.utils_cswm import get_act_fn

from algorithms.modules_representation import EncoderGeneric, DecoderGeneric, EncoderSmall, DecoderSmall, EncoderMedium, \
...
class ActionBindingAttention(nn.Module):
    ...
    def _action_attention(self, slots: Tensor, actions: Tensor, identity_embedding: Tensor):
        ...
        # > TODO use `weighted sum` instead of `weighted mean` in Slot Attention
