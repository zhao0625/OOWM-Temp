...
from algorithms.modules_decoupled_slot_attention import ActionBindingAttention, DecoupledSlotAttentionModel


class DecoupledHomomorphicWM(nn.Module):
    """
    The decoupled version: reconstruction for object representation + contrastive loss for WM
    """
    ...
    def energy(self, state, action, next_state,
        ...
        # FIXME add normalization given N? -- try disable this
